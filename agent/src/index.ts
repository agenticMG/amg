      ...
      [
        {
          ...
          settings: {
            ...
            DISTRIBUTION_WALLET_PRIVATE_KEY: process.env.DISTRIBUTION_WALLET_PRIVATE_KEY,
            AMG_TOKEN_MINT: process.env.AMG_TOKEN_MINT,
            DISTRIBUTION_SOL_RESERVE: process.env.DISTRIBUTION_SOL_RESERVE,
            DISTRIBUTION_BLACKLIST: process.env.DISTRIBUTION_BLACKLIST,
          },
        },
      ],
      { autoStart: true }
